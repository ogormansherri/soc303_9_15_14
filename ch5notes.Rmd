---
title: "Chapter 5 Measuring Dispersion Notes"
...
* Dispersion, pg 128
    * the extent of clustering or spread of the scores around the mean.
* Measures of Dispersion, pg 128
    * measures of variability that addresses degree of clustering of the scores around the mean.
* Range,  pg 129
    * simplest measure of dispersion that compares the highest score and the lowest score achieved for a given set of scores.
...
* Absolute Value, pg 131
    * distance or difference disregarding its sign. here the distance between each value of x and the mean, regardless of whether x is greater than the mean (a positive distance) or less than the mean (a negative distance).
* Variance, pg 133
    * an "average" or mean value of the squared deviation of the scores from the mean. 
* Standard Deviation, pg. 133
    * the positive square root of the variance, which provides a measure of dispersion closer in size to the mean deviation.
* Definitional Formula, pg 136
    * a formula that not only calculates the variance, but also defines or explains the concept. In the case of variance, the formula defines it as the average (mean) amount of the squared deviations of the scores from the mean.
* Computational Formula, pg 137 
    * a formula that generates a correct answer but does not seek to define what the concept, such as variance, actually is.
...
### What are the Measures of Central Tendency for the lowbirthweight Age variable in the dataset?
...
### What are the Measures of Dispersion for the lowbirthweight Age variable in the dataset?
